"Only using one forward pass as it  is and secind one with masking"
...
class BasicBlock(nn.Module):
    ...
    def forward(self, input):
        ...
        return (out, flag, norm_1, norm_2, flops)#return the flag for flexibility
...
class ResDG(nn.Module):
    ...
    def __init__(self, block, layers, h=224, w=224, num_classes=1000,
        ...
        print("model architecture from rescg_dual")
        # norm layer
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
